...
import { Title } from "../compponents/Title";
import { assets, dummyCarData } from '../assets/assets';
import {  CarCard} from "../compponents/CarCard";
    ...
    <div>
      <div className='flex flex-col items-center py-20 bg-light max-md:px-4'>
        <Title
          ...
          subTitle='Browse our selection of premimum vehicles avialble for your next adventure'
        />
      </div>

      {/* Center Search */}
      <div className='flex justify-center mt-6'>
        <div className='flex items-center bg-white px-4 max-w-140 w-full h-12 rounded-full shadow'>

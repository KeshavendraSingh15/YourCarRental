...
export const Banner = () => {
  return (
    ...
    <div className='text-white'>
        ...
        <p className='mt-2'>Monetize your vehiclee effortlessly by listing it on CarRental.</p>
        <p className='max-w-130'>We take care of insurance, driver verfication and secure payments
            so you can earn passive income, stress-free
        </p>
        <button className='px-6 py-2 bg-white hover:bg-slate-100

...
export const Footer = () => {
    return (
        <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-60 text-sm text-gray-500 border-b'>
            <div className='flex flex-wrap justify-between  items-start gap-8 pb-6 border-borderColor'>
                <div>
                    ...
                    <div className='flex items-center gap-3 mt-6'>
                       <a href="#"><img src={assets.instagram_logo} alt="Instaagram" className='w-5 h-5'/></a>
                ...
                <div>
                    ...
                    <ul className='mt-3 flex flex-col gap-1.5'>
                        <li><a href="#">123 Luxury Car</a></li>
                        <li><a href="#">San Francisco, CA 94107</a></li>
                        <li><a href="#">+1 2345678</a></li>

...
export const CarCard = ({car}) => {
  ...
  return (
    ...
    duration-500 cursor-pointer' onClick={()=>{navigate(`car-details/${car._id}`); scrollTo(0,0)}}>

        <div className='relative h-48 overflow-hidden'>
         <img src={car.image} alt='Car Image' className='w-full h-full object-cover transition-transform duration-500
         group-hover:scale-105'/>
         {car.isAvaliable && <p className='
         absolute top-4 left-4 bg-primary/90
         ...
         text-white px-3 py2 rounded-lg'>
